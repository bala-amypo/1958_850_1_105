...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    @Override
    public Appointment getAppointmentById(Long id) { return appointmentRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Appointment not found")); }
    @Override
    public List<Appointment> getAppointmentsByHostId(Long hostId) { return appointmentRepository.findByHostId(hostId); }
    @Override
    public List<Appointment> getAppointmentsByVisitorId(Long visitorId) { return appointmentRepository.findByVisitorId(visitorId); }
    @Override
